...
public class FileManager {
    ...
    private class FuctionalButtons extends JPanel {
        ...
        public FuctionalButtons() {
            ...
            JButton ViewerButton = new JButton("Open Picture Viewer");
            ...
            RenameButton.addActionListener(
               (e) -> {
                    try {
                        ...
                        //System.out.println("Old file: " + path.toString());
                        //System.out.println("New file: " + oldFileName.getParent() + "\\" + newName);
                ...
                public void actionPerformed(ActionEvent e) {
                    ...
                    if (!FTPmode[0] & !FTPmode[1]) {
                        ...
                        if (new File(sourcePath).isFile()) {
                            int confirmation = JOptionPane.showConfirmDialog(null, "Copy file " + sourcePath + "\n" + "to " + destinationPath);
                        ...
                        if (FTPmode[0] & (CurrentPath[0] + CurrentSelection[0]).equals(CurrentPathPane.getText())) {
                            ...
                            int confirmation = JOptionPane.showConfirmDialog(null, "Copy file " + sourcePath + " from FTP " + ftpAddress + "\n" + "to " + destinationPath);
                            if (confirmation == JOptionPane.OK_OPTION) {
            ...
            DeleteButton.addActionListener(new ActionListener() {
                ...
                public void actionPerformed(ActionEvent e) {
                    ...
                    if (fileToDelete.isFile()) {
                        int confirmation = JOptionPane.showConfirmDialog(null, "Delete file " + sourcePath);
            ...
            if (overwrite) {
                try (FileOutputStream fos = new FileOutputStream(file);
                    ...
                    if (!ftpMode) {
                        ...
                        info.SetUnderText("");
                        info.SetMainText("");
                        info.SetInfoText("Retrieving file " + source + " from server " + ftpAddress + ", wait...");
                    ...
                    JOptionPane.showMessageDialog(null, "Cannot copy " + source + "\n" + "Unexpected end of file!", "Exception", JOptionPane.ERROR_MESSAGE);
                }
            }
            else {
        ...
        private class FileCopyThread extends Thread {
            ...
            public void run() {
                if (!ftpMode) {
                    ...
                    info.SetInfoText("Copying file" + source + " in progress, wait..");
                }
        ...
        private class DirectoryCopyThread extends Thread {
            ...
            synchronized public void run() {
                ...
                dCopyPercent = 0;
                System.out.println("Total size = " + dirSize + ", Total file number = " + dirFileNumber);
        ...
        private void CopyDirectory(String source, String destination) {
            ...
            for (File f : fileList) {
                ...
                info.SetMainText("Total: " + (int) dCopyPercent + "%, copying file " + currentFileNumber + "\\" + dirFileNumber);
            }
        }
