/**
 * Created by y.golota on 30.11.2016.
 */
...
class TableRenderer extends JLabel implements TableCellRenderer {
    ...
    public TableRenderer (String[][] data, int n) {
        this.data = data;
        this.n = n;
    }
    ...
    public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus, int row, int column) {
        ...
        if (row !=0) {
            if (data[row][1].equals("DIR") | data[row][1].equals("ftpDIR")) setForeground(new Color(10, 10, 60));
            else setForeground(new Color(90, 90, 150));
            if (data[row][1].toLowerCase().equals("exe")) setForeground(new Color(90, 150, 90));
            if (data[row][4].contains("H")) setForeground(new Color(150, 150, 150));
            if (data[row][4].contains("R")) setForeground(new Color(250, 120, 120));
        }
